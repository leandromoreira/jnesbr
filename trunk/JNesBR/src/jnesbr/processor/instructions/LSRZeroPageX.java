 ...
 */
public class LSRZeroPageX extends IndexedZeroPageInstruction {

    public LSRZeroPageX(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "LSR $" + JNesUtil.giveMeHexaStringFormattedWith2Space(getOperandAddress()) + ", X";
    }
