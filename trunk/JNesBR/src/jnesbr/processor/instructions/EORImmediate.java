 ...
 */
public class EORImmediate extends ImmediateInstruction{
    public EORImmediate(Cpu2A03 cpu){
        super(cpu);
    }
    ...
    public String disassembler() {
        return "EOR #$" + JNesUtil.fillIfNeedsWith(2, "0", Integer.toHexString(getOperand()).toUpperCase());
    }
