 ...
 */
public class CMPAbsolute extends AbsoluteInstruction {

    public CMPAbsolute(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "CMP $" + JNesUtil.giveMeHexaStringFormattedWith4Space(getOperandAddress());
    }
