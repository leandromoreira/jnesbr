 ...
 */
public class INCAbsoluteX extends AbsoluteIndexedInstruction{

    public INCAbsoluteX(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "INC $"+JNesUtil.giveMeHexaStringFormattedWith4Space(getOperandAddress()) +", X";
    }
