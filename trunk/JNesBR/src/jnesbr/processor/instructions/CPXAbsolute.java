 ...
 */
public class CPXAbsolute extends AbsoluteInstruction{
    public CPXAbsolute(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "CPX $" + JNesUtil.fillIfNeedsWith(4, "0", Integer.toHexString(getOperandAddress()).toUpperCase());
    }
