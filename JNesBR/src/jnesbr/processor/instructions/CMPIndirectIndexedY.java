 ...
 */
public class CMPIndirectIndexedY  extends IndirectIndexedInstruction {
    private byte cycles;
    public CMPIndirectIndexedY(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "CMP ($" + JNesUtil.giveMeHexaStringFormattedWith2Space(getOperandAddress()) + ") Y";
    }
