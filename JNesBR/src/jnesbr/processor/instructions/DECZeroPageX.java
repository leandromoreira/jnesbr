 ...
 */
public class DECZeroPageX extends IndexedZeroPageInstruction {

    public DECZeroPageX(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "DEC $"+JNesUtil.giveMeHexaStringFormattedWith2Space(getOperandAddress())+", X";
    }
