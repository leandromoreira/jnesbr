 ...
 */
public class ASLAbsolute extends AbsoluteInstruction {

    public ASLAbsolute(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "ASL $"+JNesUtil.giveMeHexaStringFormattedWith4Space(getOperandAddress())+complement();
    }
