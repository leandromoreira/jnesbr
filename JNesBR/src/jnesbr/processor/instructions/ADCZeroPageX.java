 ...
 */
public class ADCZeroPageX extends IndexedZeroPageInstruction {

    public ADCZeroPageX(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "ADC $" + fillIfNeedsWith(2, "0", Integer.toHexString(getOperandAddress()).toUpperCase())+", X";
    }
