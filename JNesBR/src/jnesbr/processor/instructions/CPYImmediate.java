 ...
 */
public class CPYImmediate extends ImmediateInstruction {
public CPYImmediate(Cpu2A03 cpu){
        super(cpu);
    }
    ...
    public String disassembler() {
        return "CPY #$"+ JNesUtil.fillIfNeedsWith(2, "0", Integer.toHexString(getOperand()).toUpperCase());
    }
