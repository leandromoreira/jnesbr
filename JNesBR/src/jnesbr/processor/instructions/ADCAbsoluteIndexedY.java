 ...
 */
public class ADCAbsoluteIndexedY extends AbsoluteIndexedInstruction {

    private short cycles;

    public ADCAbsoluteIndexedY(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public void interpret() {
        ...
        int result = cpu.accumulator + getOperand(cpu.registerY) + cpu.flagCarry;
    ...
    public String disassembler() {
        return "ADC $" + JNesUtil.giveMeHexaStringFormattedWith4Space(getOperandAddress()) + ", Y";
    }
