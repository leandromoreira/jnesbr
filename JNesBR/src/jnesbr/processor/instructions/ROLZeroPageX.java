 ...
 */
public class ROLZeroPageX extends IndexedZeroPageInstruction {

    public ROLZeroPageX(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "ROL $" + JNesUtil.giveMeHexaStringFormattedWith2Space(getOperandAddress())+", X";
    }
