 ...
 */
public class INCZeroPage extends ZeroPageInstruction {

    public INCZeroPage(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "INC $" + JNesUtil.fillIfNeedsWith(2, "0", Integer.toHexString(getOperandAddress()).toUpperCase());
    }
