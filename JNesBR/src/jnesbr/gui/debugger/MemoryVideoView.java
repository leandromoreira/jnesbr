...
public class MemoryVideoView extends javax.swing.JFrame {
    ...
    private void jBtnGoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGoActionPerformed
        ...
        if (userChoose.equals("Pattern Table 0 (4K) (256 Tiles)")){
            jTMemory.setModel(Emulator.getMemoryVideoModel(jTMemory , VideoMemoryMap.PATTERN_TABLE_0_START,VideoMemoryMap.PATTERN_TABLE_0_END));
            return;
        }
        if (userChoose.equals("Pattern Table 1 (4K) (256 Tiles)")){
            jTMemory.setModel(Emulator.getMemoryVideoModel(jTMemory,VideoMemoryMap.PATTERN_TABLE_1_START,VideoMemoryMap.PATTERN_TABLE_1_END));
            return;
        }
        if (userChoose.equals("Name Table 0 and Attribute Table 0 (1K) (32x30 BG Map)")){
            jTMemory.setModel(Emulator.getMemoryVideoModel(jTMemory,VideoMemoryMap.NAME_TABLE_0_START,VideoMemoryMap.NAME_TABLE_0_END));
            return;
        }
        if (userChoose.equals("Name Table 1 and Attribute Table 1 (1K) (32x30 BG Map)")){
            jTMemory.setModel(Emulator.getMemoryVideoModel(jTMemory,VideoMemoryMap.NAME_TABLE_1_START,VideoMemoryMap.NAME_TABLE_1_END));
            return;
        }
        if (userChoose.equals("Name Table 2 and Attribute Table 2 (1K) (32x30 BG Map)")){
            jTMemory.setModel(Emulator.getMemoryVideoModel(jTMemory,VideoMemoryMap.NAME_TABLE_2_START,VideoMemoryMap.NAME_TABLE_2_END));
            return;
        }

        if (userChoose.equals("Name Table 3 and Attribute Table 3 (1K) (32x30 BG Map)")){
            jTMemory.setModel(Emulator.getMemoryVideoModel(jTMemory,VideoMemoryMap.NAME_TABLE_3_START,VideoMemoryMap.NAME_TABLE_3_END));
            return;
        }
        if (userChoose.equals("Mirror of 2000h-2EFFh")){
            jTMemory.setModel(Emulator.getMemoryVideoModel(jTMemory,VideoMemoryMap.MIRROR0_START,VideoMemoryMap.MIRROR0_END));
            return;
        }
        if (userChoose.equals("Background and Sprite Palettes (25 entries used)")){
            jTMemory.setModel(Emulator.getMemoryVideoModel(jTMemory,VideoMemoryMap.BG_SPR_PALETET_START,VideoMemoryMap.BG_SPR_PALETET_END));
            return;
        }

        if (userChoose.equals("Mirrors of 3F00h-3F1Fh")){
            jTMemory.setModel(Emulator.getMemoryVideoModel(jTMemory,VideoMemoryMap.MIRROR1_START,VideoMemoryMap.MIRROR1_END));
            return;
        }
}//GEN-LAST:event_jBtnGoActionPerformed

    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        jTMemory.setModel(Emulator.getMemoryVideoModel(jTMemory,VideoMemoryMap.PATTERN_TABLE_0_START,VideoMemoryMap.PATTERN_TABLE_1_END));
