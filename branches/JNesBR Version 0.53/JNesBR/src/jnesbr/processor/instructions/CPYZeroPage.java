 ...
 */
public class CPYZeroPage extends ZeroPageInstruction{

    public CPYZeroPage(Cpu2A03 cpu) {
        super(cpu);
    }
   ...
   @Override
    ...
    public String disassembler() {
        return "CPY $"+ JNesUtil.fillIfNeedsWith(2, "0", Integer.toHexString(getOperandAddress()).toUpperCase());
    }
