 ...
 */
public class ROLAbsoluteX extends AbsoluteIndexedInstruction {

    public ROLAbsoluteX(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "ROL $" + JNesUtil.giveMeHexaStringFormattedWith4Space(getOperandAddress()) +", X";
    }
