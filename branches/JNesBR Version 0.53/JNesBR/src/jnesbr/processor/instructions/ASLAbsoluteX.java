 ...
 */
public class ASLAbsoluteX extends AbsoluteIndexedInstruction {

    public ASLAbsoluteX(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "ASL $"+JNesUtil.giveMeHexaStringFormattedWith4Space(getOperandAddress())+", X";
    }
