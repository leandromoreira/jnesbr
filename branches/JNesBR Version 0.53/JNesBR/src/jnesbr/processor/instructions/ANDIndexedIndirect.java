 ...
 */
public class ANDIndexedIndirect extends IndirectXInstruction  {

    public ANDIndexedIndirect(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "AND ($"+JNesUtil.giveMeHexaStringFormattedWith2Space(getOperandAddress())+", X)";
    }
