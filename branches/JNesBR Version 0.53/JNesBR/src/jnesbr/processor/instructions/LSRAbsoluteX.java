 ...
 */
public class LSRAbsoluteX extends AbsoluteIndexedInstruction {

    public LSRAbsoluteX(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "LSR $" + JNesUtil.giveMeHexaStringFormattedWith4Space(getOperandAddress()) + ", X";
    }
