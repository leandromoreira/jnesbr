 ...
 */
public class ANDAbsolute extends AbsoluteInstruction {

    public ANDAbsolute(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "AND $" + JNesUtil.fillIfNeedsWith(4, "0", Integer.toHexString(getOperandAddress()).toUpperCase());
    }
