 ...
 */
public class SBCIndirectIndexed extends IndirectIndexedInstruction {
    private byte cycles;

    public SBCIndirectIndexed(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "SBC ($" + JNesUtil.giveMeHexaStringFormattedWith2Space(getOperandAddress()) + "), Y";
    }
