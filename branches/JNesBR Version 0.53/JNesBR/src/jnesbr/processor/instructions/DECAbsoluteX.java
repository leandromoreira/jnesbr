 ...
 */
public class DECAbsoluteX extends AbsoluteIndexedInstruction {

    public DECAbsoluteX(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "DEC $" + JNesUtil.fillIfNeedsWith(4, "0", Integer.toHexString(getOperandAddress()).toUpperCase()) + ", X";
    }
