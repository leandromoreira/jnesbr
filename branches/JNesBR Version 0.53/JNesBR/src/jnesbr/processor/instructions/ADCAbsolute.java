 ...
 */
public class ADCAbsolute extends AbsoluteInstruction {

    public ADCAbsolute(Cpu2A03 cpu) {
        super(cpu);
    }
    ...
    public String disassembler() {
        return "ADC $" + fillIfNeedsWith(4, "0", Integer.toHexString(getOperandAddress()).toUpperCase()) ;
    }
