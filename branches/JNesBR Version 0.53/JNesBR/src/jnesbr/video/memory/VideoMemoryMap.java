...
public class VideoMemoryMap {
    ...
    public final static int NAME_TABLE_0_START = 0x2000;
         public final static int ATTR_TABLE_0_START = 0x23C0;
         public final static int ATTR_TABLE_0_END = 0x23FF;
    public final static int NAME_TABLE_0_END = 0x23FF;
    public final static int NAME_TABLE_1_START = 0x2400;
         public final static int ATTR_TABLE_1_START = 0x27C0;
         public final static int ATTR_TABLE_1_END = 0x27FF;
    public final static int NAME_TABLE_1_END = 0x27FF;
    public final static int NAME_TABLE_2_START = 0x2800;
         public final static int ATTR_TABLE_2_START = 0x2BC0;
         public final static int ATTR_TABLE_2_END = 0x2BFF;
    public final static int NAME_TABLE_2_END = 0x2BFF;
    public final static int NAME_TABLE_3_START = 0x2C00;
         public final static int ATTR_TABLE_3_START = 0x2FC0;
         public final static int ATTR_TABLE_3_END = 0x2FFF;
